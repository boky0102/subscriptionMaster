...
type AreaYearChartProps = {
     ...
     newChartData?: ChartData[] | ChartYearData[];
               ...
               <ResponsiveContainer width={'100%'} height={props.height}>
                    <AreaChart data={props.chartData} margin={{ top: 20, left: 0, right: 50, bottom: 0 }}>
                         <defs>
                              ...
                              <linearGradient id="addedArea" x1="0" y1="0" x2="0" y2="1">
                                   <stop offset="5%" stopColor="#CCCCCC" stopOpacity={1} />
                                   <stop offset="95%" stopColor="#CCCCCC" stopOpacity={0.3} />
                              </linearGradient>
                         </defs>
                         <Area
                              type="monotone"
